    ...
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Level {peer.level}</p>
          </div>
        </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <span className="text-gray-600 text-sm">Current Project:</span>
          <span className="font-medium text-blue-600">{peer.current_project.name}</span>
        </div>
        
        <div className="flex items-center justify-between">
          <span className="text-gray-600 text-sm">Campus:</span>
          <span className="font-medium">{peer.campus}</span>
        </div>
        
        <div className="flex items-center justify-between">
          <span className="text-gray-600 text-sm">Last Login:</span>
          <span className="font-medium text-gray-900">{formatLastLogin(peer.last_login)}</span>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {localFavorites.length > 0 && (
        <div className="mt-8 bg-blue-50 rounded-lg p-4">
          <h3 className="text-lg font-semibold text-blue-900 mb-2">Your Favorite Peers</h3>
